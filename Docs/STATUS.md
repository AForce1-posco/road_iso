...
> 최종 갱신: **2026-07-10 (⭐좌표계 마이그레이션: 트레이 중심 원점 → rear-left 코너 원점. 코드18+데이터701JSON+surrogate(p95 R²0.956) 완료. ⏳BedAnchor 씬이동(−1.05,0,−3.05)+주행LTR동일 검증 남음. 상세 WORKLOG 2026-07-10)**.
