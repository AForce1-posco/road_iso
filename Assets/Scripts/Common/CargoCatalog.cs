...
public static class CargoCatalog
{
    ...
    private static CargoType[] Hardcoded()
    {
        return new[]
        {
            // 값 출처: Assets/Data/적재물데이터.xlsx (2026-07 업데이트). 무게 kg, 치수 cm(가로w·높이h·세로d).
            Box("B-001", "박스 B-001", 0.21f,  8f,  4f,  4f,  16, "자갈"),
            Box("B-002", "박스 B-002", 0.35f,  14f, 9f,  3f,  9,  "자갈"),
            Box("B-003", "박스 B-003", 0.85f,  16f, 5f,  4f,  8,  "자갈"),
            Box("B-004", "박스 B-004", 0.8f,   16f, 10f, 4f,  4,  "자갈"),
            ...
            Pipe("P-001", "흰 파이프 번들(3)", 0.82f,  7f, 6f, 58f,  2, "흰색 3개 번들"),
            Pipe("P-002", "흰 파이프 번들(2)", 0.56f,  7f, 3f, 60f,  2, "흰색 2개 번들"),
            Pipe("P-003", "스틸 파이프 번들(3)", 0.585f, 3f, 2f, 50f,  2, "스틸 3개 번들"),
            Pipe("P-004", "스틸 파이프 번들(2)", 0.545f, 3f, 1f, 70f,  2, "스틸 2개 번들"),
            Pipe("S-001", "배관 파이프 S-001", 1.078f, 4f, 4f, 39.5f, 5, "번들 제외"),
            Pipe("S-002", "배관 파이프 S-002", 1.9f,   4f, 4f, 70f,   3, "번들 제외"),
            Pipe("S-003", "배관 파이프 S-003", 2.08f,  5f, 5f, 80f,   3, "번들 제외"),
        };
    }
